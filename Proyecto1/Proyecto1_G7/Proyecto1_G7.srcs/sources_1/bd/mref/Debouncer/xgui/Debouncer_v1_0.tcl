...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "FREQ_DEB" -parent ${Page_0}
...
proc update_PARAM_VALUE.FREQ_DEB { PARAM_VALUE.FREQ_DEB } {
	# Procedure called to update FREQ_DEB when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.FREQ_DEB { PARAM_VALUE.FREQ_DEB } {
	# Procedure called to validate FREQ_DEB
	return true
}
...
proc update_MODELPARAM_VALUE.FREQ_DEB { MODELPARAM_VALUE.FREQ_DEB PARAM_VALUE.FREQ_DEB } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.FREQ_DEB}] ${MODELPARAM_VALUE.FREQ_DEB}
}
