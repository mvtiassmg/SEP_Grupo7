...
################################################################
# This is a generated script based on design: Game_v1_imp
#
...
proc create_root_design { parentCell } {
  ...
  set shoot [ create_bd_port -dir I shoot ]
  ...
  # Create instance: Sep_SM_0, and set properties
  set block_name Sep_SM
  set block_cell_name Sep_SM_0
  if { [catch {set Sep_SM_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Sep_SM_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net ClockDivider_0_clk_out [get_bd_pins ClockDivider_0/clk_out] [get_bd_pins RNGCore_0/clk] [get_bd_pins Sep_SM_0/clk]
