...
entity Game_v1_imp is
  ...
  attribute CORE_GENERATION_INFO of Game_v1_imp : entity is "Game_v1_imp,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Game_v1_imp,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=6,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of Game_v1_imp is
  ...
  signal Sep_SM_0_leds : STD_LOGIC_VECTOR ( 3 downto 0 );
...
begin
  ...
  clk_1 <= clk;
  enable_1 <= enable;
  leds(3 downto 0) <= Sep_SM_0_leds(3 downto 0);
  reset_1 <= reset;
