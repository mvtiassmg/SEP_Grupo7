...
entity RNGCore_imp is
  ...
  attribute CORE_GENERATION_INFO of RNGCore_imp : entity is "RNGCore_imp,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=RNGCore_imp,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=5,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of RNGCore_imp : entity is "RNGCore_imp.hwdef";
end RNGCore_imp;

architecture STRUCTURE of RNGCore_imp is
  component RNGCore_imp_RNGCore_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    enable : in STD_LOGIC;
  ...
  end component RNGCore_imp_RNGCore_0_0;
  ...
  component RNGCore_imp_Debouncer_0_2 is
  port (
    clk : in STD_LOGIC;
    btn : in STD_LOGIC;
    btn_out : out STD_LOGIC
  );
  end component RNGCore_imp_Debouncer_0_2;
  component RNGCore_imp_Debouncer_2_0 is
  port (
    clk : in STD_LOGIC;
    btn : in STD_LOGIC;
    btn_out : out STD_LOGIC
  );
  end component RNGCore_imp_Debouncer_2_0;
  ...
  signal shot_1 : STD_LOGIC;
  signal NLW_RNGCore_0_magnum_status_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
...
Debouncer_2: component RNGCore_imp_Debouncer_0_2
     port map (
      btn => btnRNG_1,
      btn_out => Debouncer_2_btn_out,
      clk => clk_1
    );
Debouncer_3: component RNGCore_imp_Debouncer_2_0
     port map (
      btn => shot_1,
      btn_out => Debouncer_3_btn_out,
      clk => clk_1
    );
RNGCore_0: component RNGCore_imp_RNGCore_0_0
     port map (
      btnRNG => Debouncer_2_btn_out,
      clk => ClockDivider_0_clk_out,
      enable => enable_1,
      ending => RNGCore_0_ending,
      magnum_status(7 downto 0) => NLW_RNGCore_0_magnum_status_UNCONNECTED(7 downto 0),
      pos_bala(3 downto 0) => RNGCore_0_pos_bala(3 downto 0),
      reset => Debouncer_0_btn_out,
      shot => Debouncer_3_btn_out
    );
end STRUCTURE;
