...
################################################################
# This is a generated script based on design: RNGCore_imp
#
...
# source RNGCore_imp_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# ClockDivider, Debouncer, Debouncer, Debouncer, RNGCore
...
proc create_root_design { parentCell } {
  ...
  set shot [ create_bd_port -dir I shot ]
  ...
  if { [catch {set RNGCore_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $RNGCore_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net ClockDivider_0_clk_out [get_bd_pins ClockDivider_0/clk_out] [get_bd_pins RNGCore_0/clk]
  connect_bd_net -net Debouncer_0_btn_out [get_bd_pins Debouncer_0/btn_out] [get_bd_pins RNGCore_0/reset]
  connect_bd_net -net Debouncer_2_btn_out [get_bd_pins Debouncer_2/btn_out] [get_bd_pins RNGCore_0/btnRNG]
  connect_bd_net -net Debouncer_3_btn_out [get_bd_pins Debouncer_3/btn_out] [get_bd_pins RNGCore_0/shot]
  connect_bd_net -net RNGCore_0_ending [get_bd_ports rgb_b] [get_bd_pins RNGCore_0/ending]
  connect_bd_net -net RNGCore_0_pos_bala [get_bd_ports leds] [get_bd_pins RNGCore_0/pos_bala]
  connect_bd_net -net btnRNG_1 [get_bd_ports btnRNG] [get_bd_pins Debouncer_2/btn]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins ClockDivider_0/clk] [get_bd_pins Debouncer_0/clk] [get_bd_pins Debouncer_2/clk] [get_bd_pins Debouncer_3/clk]
  ...
  connect_bd_net -net shot_1 [get_bd_ports shot] [get_bd_pins Debouncer_3/btn]
