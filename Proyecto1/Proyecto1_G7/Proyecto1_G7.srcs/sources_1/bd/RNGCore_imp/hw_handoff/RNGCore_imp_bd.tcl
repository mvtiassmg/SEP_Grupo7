...
# module references:
# ClockDivider, Debouncer, Debouncer, RNGCore
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Debouncer_0_btn_out [get_bd_pins Debouncer_0/btn_out] [get_bd_pins RNGCore_0/btnRNG]
  connect_bd_net -net Debouncer_1_btn_out [get_bd_pins Debouncer_1/btn_out] [get_bd_pins RNGCore_0/reset]
  ...
  connect_bd_net -net btnRNG_1 [get_bd_ports btnRNG] [get_bd_pins Debouncer_0/btn]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins ClockDivider_0/clk] [get_bd_pins Debouncer_0/clk] [get_bd_pins Debouncer_1/clk]
  connect_bd_net -net enable_1 [get_bd_ports enable] [get_bd_pins RNGCore_0/enable]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins Debouncer_1/btn]
