...
--               d:/SEP/SEP_Grupo7/Proyecto1/Proyecto1_G7/Proyecto1_G7.srcs/sources_1/bd/GameModeSel_imp/ip/GameModeSel_imp_Debouncer_0_0_1/GameModeSel_imp_Debouncer_0_0_sim_netlist.vhdl
-- Design      : GameModeSel_imp_Debouncer_0_0
...
entity GameModeSel_imp_Debouncer_0_0_ClockDivider is
  port (
    clk_out_reg_reg_0 : out STD_LOGIC;
    clk : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of GameModeSel_imp_Debouncer_0_0_ClockDivider : entity is "ClockDivider";
end GameModeSel_imp_Debouncer_0_0_ClockDivider;

architecture STRUCTURE of GameModeSel_imp_Debouncer_0_0_ClockDivider is
  signal clk_out_reg : STD_LOGIC;
  signal clk_out_reg_i_1_n_0 : STD_LOGIC;
  signal \^clk_out_reg_reg_0\ : STD_LOGIC;
...
begin
  clk_out_reg_reg_0 <= \^clk_out_reg_reg_0\;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GameModeSel_imp_Debouncer_0_0_Debouncer is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of GameModeSel_imp_Debouncer_0_0_Debouncer : entity is "Debouncer";
end GameModeSel_imp_Debouncer_0_0_Debouncer;

architecture STRUCTURE of GameModeSel_imp_Debouncer_0_0_Debouncer is
  ...
  signal btn_reg_i_6_n_0 : STD_LOGIC;
  signal btn_reg_i_7_n_0 : STD_LOGIC;
  signal btn_reg_i_8_n_0 : STD_LOGIC;
  signal btn_tmp : STD_LOGIC;
  signal clk_div_inst_n_0 : STD_LOGIC;
...
btn_reg_i_2: unisim.vcomponents.LUT6
    generic map(
...
btn_reg_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
btn_reg_i_4: unisim.vcomponents.LUT6
    generic map(
...
btn_reg_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
btn_reg_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
btn_reg_i_7: unisim.vcomponents.LUT6
    generic map(
...
btn_reg_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
btn_tmp_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
clk_div_inst: entity work.GameModeSel_imp_Debouncer_0_0_ClockDivider
     port map (
      clk => clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GameModeSel_imp_Debouncer_0_0 is
  port (
    clk : in STD_LOGIC;
    btn : in STD_LOGIC;
    btn_out : out STD_LOGIC
  ...
  attribute NotValidForBitStream of GameModeSel_imp_Debouncer_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of GameModeSel_imp_Debouncer_0_0 : entity is "GameModeSel_imp_Debouncer_0_0,Debouncer,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of GameModeSel_imp_Debouncer_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of GameModeSel_imp_Debouncer_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of GameModeSel_imp_Debouncer_0_0 : entity is "Debouncer,Vivado 2020.1";
end GameModeSel_imp_Debouncer_0_0;

architecture STRUCTURE of GameModeSel_imp_Debouncer_0_0 is
  attribute x_interface_info : string;
  attribute x_interface_info of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of clk : signal is "XIL_INTERFACENAME clk, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN GameModeSel_imp_clk, INSERT_VIP 0";
begin
U0: entity work.GameModeSel_imp_Debouncer_0_0_Debouncer
     port map (
      btn => btn,
      btn_out => btn_out,
      clk => clk
